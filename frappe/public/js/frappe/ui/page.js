	...
	add_custom_button_group(label, icon, parent) {
		...
		<div class="dropdown1">
					...
					<ul class="dropdown-menu1"
					    ...
					    <button type="button" class="btn btn-default btn-sm ellipsis"  aria-expanded="false" onclick="location.href='http://127.0.0.1:8003/app/role'">Roles</button>
				<button type="button" class="btn btn-default btn-sm ellipsis"  aria-expanded="false" onclick="location.href='http://127.0.0.1:8003/app/permission-manager'">Permission</button><button type="button" class="btn btn-default btn-sm ellipsis"  aria-expanded="false" onclick="location.href='http://127.0.0.1:8003/app/role-profile'"></button>
					</ul>
				    </div>
				    `);
		...
		return custom_btn_group1.find(".dropdown-menu1");
	}
